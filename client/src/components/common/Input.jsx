  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full ${className}`}>
      ...
      <input
        ...
        max={max}
        step={step}
        className={`w-full px-3.5 py-2.5 rounded-md border text-(length:--text-body) bg-surface-elevated transition-colors duration-200 focus:outline-none focus:border-terracotta disabled:opacity-60 disabled:cursor-not-allowed ${
